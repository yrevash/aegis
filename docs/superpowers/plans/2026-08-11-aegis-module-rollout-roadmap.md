...
- [x] 1. `aegis.ml` (DONE — d427739,cfb6d64; SHAP+conformal stream) · [x] 2. `aegis.retrieval` (DONE 2026-08-12, MERGE-READY — a3a45a7,0a26011,546bb5e; aegis 164 pass w/o heavy deps, backend parity green; citations stream; agentic loop moved in; +aegis.core.models.ModelRole) · [x] 3. `aegis.gateway` (DONE 2026-08-12, MERGE-READY — dc2505a,c6f61a7; LiteLLM shape byte-identical, governance+observability injected hooks, enforce-before-spend + fail-closed preserved, BudgetExceededError identity intact, model_call stream; aegis 193 pass, backend budget parity 10 pass) · [x] 4. `aegis.memory` + **`aegis.data`** (DONE 2026-08-12, MERGE-READY — 7437a94,0d1de60,7d5ab4c; shared portable ORM foundation [AegisBase/VectorType/JsonB] under aegis[data]; tenant isolation preserved; MemorySpec injected; aegis 243 pass)
  · [x] 5. `aegis.governance` (DONE 2026-08-12, MERGE-READY — 25f0379,2bd303c; JWT/Argon2/RBAC/RLS/budget all byte-identical, security-critical logic preserved, 50 backend security tests un-weakened; reuses aegis.data; aegis 277 pass) · [ ] 6. `aegis.evals`+`aegis.ops` · [ ] 7. `aegis.observability` · [ ] 8. `aegis.agent` (LAST — composes all)
