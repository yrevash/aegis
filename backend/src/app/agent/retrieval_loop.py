...
- Dependencies are **injected**: ``retrieve_fn`` (the real pipeline) and an optional
  ``rewrite_fn`` (:func:`app.retrieval.query_rewrite.rewrite_query`). Under a fake
...
Merging mirrors how :class:`app.retrieval.pipeline.Retriever` assembles a result:
sources are unioned and deduped by :attr:`~app.retrieval.models.Source.id` (keeping
...
from app.retrieval.protocols import CompleteFn
from app.retrieval.query_rewrite import CallUsage, RewriteResult, usage_of
from app.retrieval.spotlight import build_spotlighted_context
...
def _merge_results(
    ...
    Sources sharing an :attr:`~app.retrieval.models.Source.id` collapse to the higher-
...
class AgenticRetrievalResult:
    ...
    Attributes:
        result: The final MERGED :class:`~app.retrieval.models.RetrievalResult`.
