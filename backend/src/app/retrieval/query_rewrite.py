...
:mod:`app.retrieval.reranker` (positional ``role, messages``; keyword
...
class CallUsage:
    ...
    A lightweight, dependency-free mirror of ``app.core.llm.Usage`` so the pure-logic
...
async def rewrite_query(
    ...
    *,
    ...
    Args:
        ...
        complete: The chat-completion callable (shape of ``app.core.llm.complete``); when
