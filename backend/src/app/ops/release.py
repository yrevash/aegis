...
Gap 2, "smart tiered"). :mod:`app.ops.diagnose` only ever proposes a *draft*; this module is
...
def _baseline(
    active: PromptVersion | None, prompt_key: str
    ...
    return render_system_prompt(get_persona(prompt_key)), None
...
async def release(
    ...
    * ``"manual"`` — always enqueue for approval, whatever the risk.
    ...
    baseline_prompt, baseline_config = _baseline(active, draft.prompt_key)
