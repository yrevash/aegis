...
- **Aegis Memory** (Postgres + pgvector) — bitemporal episodic/semantic/procedural memory.
- **Aegis Cache** (Redis) — semantic response cache.
- **Aegis Retrieval** (Neo4j/LightRAG + pgvector) — hybrid vector+graph+BM25 RAG, RRF, LLM rerank.
