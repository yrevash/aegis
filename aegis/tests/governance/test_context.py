"""Contract tests: the GovernanceContext contextvar seam.

The set / get / reset helpers over the process-wide ContextVar plus the typed context;
the default must be ``None`` so an unscoped flow behaves exactly as before.
"""
