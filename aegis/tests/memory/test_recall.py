...
async def test_recall_offers_skill_cards_and_never_a_body(db):
    """§10.2 tier 1, at the recall seam: names and descriptions only.
    ...
    the assertion is inverted rather than deleted because the *regression* worth
    catching is a body finding its way back into the recall bundle: it would work,
    it would answer correctly, and progressive disclosure would be gone with nothing
