...
/** A single outcome tile in the value spine. */
function ValueTile({
  icon: Icon,
  title,
  signal,
...
/**
 * The management **value spine** as a four-tile bento — the outcomes a buyer
 * signs off on: **Savings · Security · Performance · Audit**. Each tile is icon +
 * number + one line, with the explanatory prose relocated to an ⓘ tooltip.
 * Live-measured figures carry a green dot; anything the backend cannot measure
 * yet is honestly badged "sample".
 */
