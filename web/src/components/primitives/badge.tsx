  ...
  'inline-flex items-center justify-center gap-1 rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 font-mono tracking-wide transition-colors',
  {
    variants: {
      ...
      variant: {
        ...
        agent: 'border-blue-200/50 bg-blue-200/12 text-blue-700',
        graph: 'border-blue-400/50 bg-blue-400/12 text-blue-600',
        ...
        ml: 'border-blue-100/50 bg-blue-100/12 text-blue-800',
      },
    },
    defaultVariants: {
      variant: 'default',
