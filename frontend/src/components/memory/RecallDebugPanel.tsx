...
import { getRecallDebug } from '@/api/client'
...
import type { RecallDebugItem } from '@/types/memory'
  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <Badge variant={item.injected ? 'ok' : 'outline'} className="shrink-0 text-[0.54rem]">
...
/**
 * "Why did it recall this?" (§4.3) — the flagship recall trace, demoted from a
 * primary full-width row to an admin expander. Given a query it shows the ranked
 * memories, each with Match / Fresh / Weight meters (the honest
 * relevance × recency × importance, in plain words), which cleared the cut, the
 * assembled context the model sees, and how much of the context budget it used.
 */
