 ...
 * SSR/tests and stays visually quiet inside dense rows. The fill eases its width
 * so it "grows" when a tile reveals (motion §2.5), and lands instantly under
 * reduced motion (the global reset neutralises the transition).
 */
