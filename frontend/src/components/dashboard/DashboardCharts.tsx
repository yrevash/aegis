...
/**
 * The three-chart row of the Overview bento (§4.2 Row 3): **Cost trend**
 * (`AreaChart`), **Model mix** (`DonutChart`, live from `/metrics`) and **Query
 * volume** (`BarChart`). Real recharts, each drawing in on mount. The trend and
 * volume series are illustrative fixtures (no backend field yet) and keep their
 * honest "sample" badge; the model-mix donut is backed by real `/metrics` data.
 */
