...
/**
 * The unit-economics detail (§4.2) — the layer beneath the money hero. Two
 * honestly-separated stories, both derived in the pure `roi.ts` module:
 ...
 *    *real* per-query cost.
 *
 * Lives inside the "Cost breakdown" expander so the primary surface stays a
 * number, not a wall of prose. Every non-measured input keeps its sample note.
 */
