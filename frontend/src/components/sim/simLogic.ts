/**
 * Pure decision logic for the Access demo (§4.8), kept free of React and
 * recharts so it can be unit-tested in the Node/vitest environment (importing
 * a charting component into a `.test.ts` hangs the runner). The view maps these
 * outcomes to ✓ / ✗ / ● / — markers; here we only decide them from live state.
 */
